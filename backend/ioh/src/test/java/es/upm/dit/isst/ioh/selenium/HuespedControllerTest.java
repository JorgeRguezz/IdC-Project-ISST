...
public class HuespedControllerTest {
    ...
    public void testRegisterAndLogin() {
        ...
        WebElement roleHuespedButton = driver.findElement(By.id("roleHuesped"));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", roleHuespedButton);
        System.out.println("Visible: " + roleHuespedButton.isDisplayed());
        System.out.println("Habilitado: " + roleHuespedButton.isEnabled());
        ((JavascriptExecutor) driver).executeScript("arguments[0].click();", roleHuespedButton);
        ...
        confirmPasswordField.sendKeys("huespedabc");
        ...
        loginEmailField.sendKeys("huesped@email.com");
        ...
        updatedPasswordField.sendKeys("huespedabc");
